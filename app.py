...
from appchatbot import Chatbot
...
if __name__ == "__main__":
    ...
    # no = input('enter a choiceto evaluate the model 1) majority based 2) Rule based 3) Logistic reg 4) Descison tree (0) To use the bot' )
    # if no =='1':
